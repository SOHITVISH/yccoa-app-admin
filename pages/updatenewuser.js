...
const updatenewuser = () => {
    ...
    useEffect(() => {
        if (router.isReady) {
            ...
            setPhone(state.singleemployee.phone)
        }
    ...
    const handleUpdate = async () => {
        ...
        try {
            ...
            updateEmployee({ id: router.query.id, employee_status: employee_status, first_name: first_name, last_name: last_name, email: email,phone:phone, gender: gender })
            setLoading(false)
