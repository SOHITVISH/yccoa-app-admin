  ...
  return (
    <Container fluid className="p-6">
      ...
      <div className="d-flex justify-content-between align-items-center">
        ...
        <p style={{ color: "Black" }}><IoMdArrowRoundBack style={{ color: "black", fontSize: "30", cursor: "pointer" }} onClick={handleback} />Go back</p>
      </div>
      ...
      <Row className="align-items-center">
        <Col xl={12} lg={12} md={12} xs={12}>
          ...
          <div className="bg-white rounded-bottom smooth-shadow-sm ">
            <div className="d-flex align-items-center justify-content-between pt-4 pb-6 px-4 d-flex flex-column flex-sm-row">
      ...
      <Row style={{ marginTop: "15px" }}>
        ...
        <div className='d-flex flex-column flex-sm-row' style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <Col xl={12} lg={12} md={12} xs={12} className="mb-2">
                ...
                <Card>
                  ...
                  <Card.Body>
                    ...
                    <Row className='d-flex flex-column flex-sm-row' style={{ display: "flex" }}>

                      {/* <h6 className=" fs-20 ls-2 text-secondary">{DateTime.fromISO(item.checked_in_at).toFormat('LLL dd, yyyy')}</h6>  */}

                      <Col className='text-center text-md-left'  >
                        <h6 className=" fs-5 ls-2 text-success" style={{ textAlign: "left" }}>Check-in At </h6>
                        <p className="mb-0 text-dark" style={{ textAlign: "left" }}>{item.checked_in_location}</p>
                      </Col>


                      <Col className='text-center text-md-center mt-3 mt-md-0' >
                        ...
                        <p className="mb-0 text-dark" style={{ textAlign: "center" }}>{item.work_duration}</p>
                      </Col>
