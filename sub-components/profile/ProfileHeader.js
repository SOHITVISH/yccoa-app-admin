      ...
      <Col xl={12} lg={12} md={12} xs={12}>
        ...
        <div className="bg-white rounded-bottom smooth-shadow-sm ">
          <div className="d-flex align-items-center justify-content-between pt-4 pb-6 px-4">
            <div className="d-flex align-items-center">
              ...
              <div className="lh-1">
                ...
                <p className="mb-0 d-block">ritty@gmail.com</p>
              </div>
            </div>
            <div>

              <p >Working hours &nbsp;&nbsp;<span style={{ border: "1px solid green", borderRadius: "5px", padding: "5px",fontWeight: "bold" }}>26Hours</span></p>
          ...
          <ul className="nav nav-lt-tab px-4" id="pills-tab" role="tablist">
            ...
            {/* <li className="nav-item">
              <Link className="nav-link" href="/employeeprofileactivity">
                Activity
              </Link>
            </li> */}
          </ul>
